                        ...
                        renderItem = {({item})=>{
                            return (
                                <Button onPress={() => onPressItem(item)} >
                                    <View style={{flex:20, paddingHorizontal:30,paddingHorizontal:8}}>
                                            <Typography fontSize={24} numOfLines={1}>{item.title}</Typography>
                                            <Typography fontSize={16} numOfLines={2} color='gray'>{item.description}</Typography>
